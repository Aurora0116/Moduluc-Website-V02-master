...
const PRMSToken: NextPage = () => {
  return (
    <>
      <NextSeo
        title="Moduluc | PRMS Token"
        description="$PRMS is an SPL utility token that will be used for various functions inside the Parametrise ecosystem. 1 bilion
                PRMS total fixed suply"
        openGraph={{
          url: 'https://moduluc-v02.herokuapp.com/token',
          title: 'Moduluc | PRMS Token',
          description: '$PRMS is an SPL utility token that will be used for various functions inside the Parametrise ecosystem. 1 bilion PRMS total fixed suply',
          images: [
            {
              url: 'https://moduluc-v02.herokuapp.com/img/seo/PRMS-token.jpg',
              width: 800,
              height: 600,
              alt: 'Moduluc',
              type: 'image/jpeg',
